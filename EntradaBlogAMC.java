...
public class EntradaBlogAMC {
     ...
     */
    public EntradaBlogAMC(int id, String autor, String texto) throws IllegalArgumentException {
    ...
    public static void main(String[] args) {
         ...
         * Modificar
         */
        EntradaBlogAMC e1 = new EntradaBlogAMC(-3, "Alex", "Últimas noticias, está disponible BixBy 2.0");
